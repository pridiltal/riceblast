...
The univariate `CropGuard` framework first builds a model for the plant’s typical behaviour and then forecasts the expected future values for the test-phase window. The following code defines the test window for potential blast detection:
...
As illustrated in the figure below, the `cropguard` package operationalizes the univariate analysis framework through three key functions.
...
test_result <- cropguard::test_extremes_uni(analysis_result, test_data = test_f1, h = 1000)
...
```{r echo=FALSE}
analysis_result <- readRDS(system.file("extdata", "analysis_example_evd.rds", package = "cropguard"))
test_result <- readRDS(system.file("extdata", "test_result_example_evd.rds", package = "cropguard"))
plots <- readRDS(system.file("extdata", "plots_example_evd.rds", package = "cropguard"))
```
...
```{r echo=FALSE}
analysis_result <- readRDS(system.file("extdata", "analysis_example_boxplot.rds", package = "cropguard"))
test_result <- readRDS(system.file("extdata", "test_result_example_boxplot.rds", package = "cropguard"))
plots <- readRDS(system.file("extdata", "plots_example_boxplot.rds", package = "cropguard"))
```
